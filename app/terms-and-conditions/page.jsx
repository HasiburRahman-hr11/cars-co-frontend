...
const TermsAndConditions = () => {
  return (
    <>
      <section className="bg-[#f9f9f9] py-[6rem] xl:py-[13rem]">
        <div className="container">
          <h1 className="text-center text-[3rem] xl:text-[6rem]">
            Terms & <b>Conditions</b>
          </h1>
        </div>
      </section>

      <section className="bg-white pb-[4rem] pt-[3rem] xl:pb-[10rem] xl:pt-[8rem]">
        <div className="container">
          <div className="blog-detail-content">
            ...
            <p>
              This website is operated by Big Boy Toyz Pvt Ltd.
              <b>
                Throughout the site, the terms “we”, “us” and “our” refer to Big
                Boy Toyz Pvt Ltd. Big Boy Toyz Pvt Ltd offers this website,
            ...
            <p>
              You agree to indemnify, defend and hold harmless Big Boy Toyz Pvt
            ...
            <p>
              ...
              limited to, taxes, change in registration, and transportation. All
              product information such as price, colour, engine specifications,
              service history, registration, etc is accurate to the day and date
              of posting.
              <b>
            ...
            <h2>
              Section 21 - <b>Restrictions on Use of Big Boy Toyz Materials</b>
            </h2>
            ...
            <p>
              ...
              indirectly in any medium. Neither these materials nor any portion
              thereof may be stored in a computer except for personal and
              non-commercial use.
              <b>
                Big Boy Toyz will not be held liable for any delays, errors or
                omissions there from, or in the transmission or delivery of all
                or any part thereof, or for any damages arising from any of the
                foregoing.
              </b>
            </p>
            ...
            <p>
              ...
              out such as Name, Email ID, Phone Number and Message is stored in
              our database.
            </p>

            <p>
              The conversation between you and our Live Chat representative is
              recorded for internal training and safety purpose. No part of this
              conversation is given to Third Party Users or impeached by any
              department. Every conversation is stored for future references so
              as to make your experience more personalised and relevant.
            </p>

            <p>
              <b>By using live chat, you adhere to the terms of our policy.</b>
            </p>
            ...
            <p>
              <a href="mailto:sales@cars.co.in.com">
                <b>sales@cars.co.in.com</b>
              </a>
            </p>

            <p>
              <a href="tel:+919999999908">
                <b>+91 9999 9999 08</b>
              </a>
            </p>
