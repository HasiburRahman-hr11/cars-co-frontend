  ...
  return (
    ...
    >
      ...
      {!isSubmitted ? (
        ...
        <div className="w-[90%] bg-black text-white popupScrollbar z-20 mx-auto relative overflow-x-hidden lg:w-[80%] lg:rounded-[1.5rem] lg:max-h-[90vh] xl:w-[70%] 2xl:max-w-[560px] shadow-xl">
          <div
            className=" absolute top-[2rem] right-[2rem] w-[2.6rem] h-[2.6rem] cursor-pointer"
            onClick={togglePopup}
          >
          ...
          <div className=" overflow-y-auto px-8 py-12 xl:px-12 flex items-center justify-center h-[300px] 1xl:h-[400px] text-center">
            <div>
              <img
