        ...
        >
          <div className="bg-white py-[4rem] px-[2rem] rounded-[1rem] w-[95%] max-w-[600px] xl:max-w-[1140px] mx-auto lg:w-[70%] xl:pl-[3rem] xl:rounded-[2rem] 1xl:max-w-[1240px] 1xl:px-[4rem] 1xl:rounded-[2.5rem] 3xl:px-[6rem] 3xl:py-[5rem] shadow-slate-400 z-100 transition-all duration-500 ease-in-out relative">
            ...
            <div className="flex justify-between items-center gap-x-[3rem]">
              <div className="flex-[1] flex flex-wrap items-center gap-[3rem]">
                <img
              ...
              <div className="w-max">
                <Link
                  href="/list-cars"
                  className="bg-black urbanist w-full px-[3rem] py-[1.4rem] text-white text-[1.8rem] rounded-[4rem] font-medium cursor-pointer md:w-max md:mx-auto md:px-[5rem] md:mt-[1rem] lg:mr-0 xl:text-[2.2rem] xl:py-[1.9rem] xl:rounded-[8rem] transition-all duration-500 hover:bg-[#FE0000] whitespace-nowrap"
                >
                  List Your Car
                </Link>
              </div>
