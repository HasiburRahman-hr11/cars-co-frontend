      ...
      <div className="container">
        <div className="py-[6rem] xl:py-[13rem] border-t border-t-[#7C7C7C]">
          <div className="flex flex-wrap">
            ...
            <div className="w-[70%] mx-auto mt-[2rem] text-center">
              <img
          ...
          <div className="mt-[4rem] grid grid-cols-1 gap-[3rem]">
            {reviews.map((review, index) => (
              <div key={index}>
                {review.reviewType === "text" && (
                  <div className="px-[2rem] py-[3rem] border border-[#4E4E4E] rounded-[2rem]">
                    <img
                      src="/images/quote-icon-red.webp"
                      alt=""
                      className="object-contain w-[4rem] xl:w-[6.6rem]"
                    />
                    <p className="mt-[3rem] text-white font-medium text-[1.8rem] xl:text-[2.4rem]">
                      "{review.reviewText}"
                    </p>
                    <div className="flex items-center mt-[3rem] pt-[2rem] border-t border-t-[#4E4E4E]">
                        <img src={review.avatar} alt={review.name} className="object-cover w-[4rem] h-[4rem] rounded-[0.7rem] xl:rounded-[1.3rem] xl:w-[8.2rem] xl:h-[8.2rem]" />
                        <div className="flex-[1] pl-[2rem]">
                            <h6 className="text-white font-medium text-[1.8rem] xl:text-[2.4rem]">{review.name}</h6>
                            <span className="text-[#dddddd] text-[1.4rem] xl:text-[1.5rem]">{review.designation}</span>
                        </div>
                    </div>
                  </div>
                )}
                ...
                {review.reviewType === "video" && (
                  ...
                  >
                    <video
                      ...
                      className="w-full h-[57rem] object-cover block rounded-[1.6rem]"
                      preload="metadata"
                      playsInline
                      controls={false}
                      loop={false}
