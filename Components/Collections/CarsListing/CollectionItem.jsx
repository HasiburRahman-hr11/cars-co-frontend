...
const CollectionItem = ({ data, togglePopup }) => {
  return (
    <div className="pb-16 bg-[#fff] common-car-item transition-all duration-500 ease-in-out">
      <Link
        href={`/cars/${data._id}`}
        className="block w-full px-[2rem] py-10 md:px-10 xl:px-[4rem] xl:py-[4rem]"
      >
        <p
        ...
        <p
          className={`text-[1.4rem] mt-[0.5rem] font-[600] lg:mt-3 xl:mt-[0.5rem] xl:text-[2.2rem]`}
        >
          ₹ {data.price}
        </p>
      </Link>
      ...
      <div className="px-[2rem] pt-8 md:px-10 xl:px-[3rem] 1xl:px-[4rem] 1xl:pt-[2.5rem] 3xl:pt-[3rem] ">
        <Link href={`/cars/${data._id}`} className="block xl:pt-4">
          <ul className="flex carCommonInfo [&>*:first-child]:pl-0 [&>*:first-child]:border-0">
            <li className="w-2/6 pl-[1.7rem] border-l border-[rgb(207,207,207)] sm:pl-[1.2rem]">
              ...
              <h6 className={`text-lg xl:text-[1.4rem] font-[600] `}>
                {" "}
