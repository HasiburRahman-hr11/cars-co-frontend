...
const BottomBanner = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#DDF0F7]">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col pt-[8rem] md:justify-center md:py-[8rem] bg-gradient-to-r from-[rgba(0,0,0,0.8)] to-[rgba(0,0,0,0.1)]">
        <div className="container text-center md:text-left">
          ...
          >
            ...
            <h2 className="text-white leading-[1.3] text-[2.6rem] [&>br]:hidden md:[&>br]:block xl:text-[4.5rem] xl:leading-[1.2] lg:w-[80%] xl:w-[75%]">
              <b>Your journey starts here,</b> unlocking trust & premium car
              ownership.
            </h2>
            <p className="mt-[2rem] text-white xl:text-[2.2rem]">
            ...
            <div className="flex flex-wrap justify-center items-center gap-x-[1rem] md:justify-start mt-[3rem] xl:mt-[5rem]">
              <Link
                href="/list-cars"
                className="inline-block bg-white text-black text-[1.5rem] px-[3rem] py-[1.3rem]  rounded-[5rem] xl:text-[2.2rem] xl:py-[1.8rem] xl:px-[6rem] hover:bg-[#FE0000] hover:text-white transition-all duration-500"
              >
                List Cars
              </Link>
            </div>
