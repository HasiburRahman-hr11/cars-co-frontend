...
const BannerSection = () => {
  return (
    <section className="bg-[#1B1A1D] text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-end sm:justify-center pt-[12rem] pb-[7rem]">
        <div className="container text-center sm:text-left">
          <h6 className="w-max mx-auto sm:ml-0  bg-white px-[3rem] pb-[0.5rem] pt-[0.8rem] text-black text-[1.3rem] uppercase rounded-[4rem] leading-[1.6] mb-[2rem] xl:text-[2rem] font-[500]">
            Contact Us
          </h6>
