...
const Testimonials = () => {
  ...
  return (
    <section className="bg-[#0D0D0D] py-[6rem] overflow-hidden xl:py-[13rem]">
      ...
      {/* Video SLider Mobile */}
      <div className=" relative mx-auto mt-[4rem] hp-testimonial-slider pl-[2rem] lg:pl-[30px] xl:w-[90%] xl:px-[20px] xl:mt-[7rem] lg:hidden">
      ...
      <div className="hidden lg:block relative mx-auto mt-[4rem] hp-testimonial-slider pl-[2rem] lg:pl-[30px] xl:w-[90%] xl:px-[25px] xl:mt-[7rem]">
