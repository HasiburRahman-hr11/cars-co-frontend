    ...
    <section className="bg-white py-[6rem] lg:pb-[0] xl:pt-[13rem]">
      <div className="container">
        <div className="text-center section-header lg:text-left lg:w-[50%] 2xl:w-[43%]">
          <h6 className="w-max mx-auto bg-white border border-[#4D4D4D] px-[3rem] py-[1.4rem] text-[#4D4D4D] text-[1.3rem] uppercase rounded-[4rem] leading-1 mb-[2rem] xl:text-[2rem] xl:leading-[1] xl:mb-[3rem] font-medium lg:ml-0">
            Achievements
          </h6>
