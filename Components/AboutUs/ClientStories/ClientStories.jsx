...
const ClientStories = () => {
  return (
    <section className="bg-black py-[6rem] overflow-hidden">
      ...
      <div className="max-w-[1920px] full-width-gallery-slider mx-auto mt-[4rem]">
        <Slider {...sliderSettings}>
          {galleryImages.map((item, index) => (
            <div key={index} className="h-full px-[0.7rem] ">
              <img
                src={item.image}
                alt="Gallery Image"
                className="w-[85vw] h-full block object-cover"
              />
            </div>
          ))}
        </Slider>
      ...
      <div className="container">
        <div className="text-center text-[1.6rem] xl:text-[2.6rem] text-white font-medium mt-[4rem] max-w-[540px] mx-auto">
