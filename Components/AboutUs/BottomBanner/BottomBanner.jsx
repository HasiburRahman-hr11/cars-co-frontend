    ...
    <section className="relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col pt-[8rem] md:justify-center md:py-[8rem]">
        <div className="container text-center md:text-left">
          <div className="w-full max-w-[540px] mx-auto md:ml-0">
            <h6 className="w-max mx-auto bg-[#202020] px-[3rem] py-[1.4rem] text-[#AEAEAE] text-[1.3rem] uppercase rounded-[4rem] leading-1 mb-[2rem] xl:text-[2rem] xl:leading-[1] xl:mb-[3rem] font-medium md:ml-0">
              start your journey
            </h6>
            <h2 className="text-black leading-[1.3] text-[2.6rem] [&>br]:hidden md:[&>br]:block xl:text-[4.5rem] xl:leading-[1.2]">
            ...
            <div className="flex flex-wrap justify-center items-center gap-x-[1rem] md:justify-start">
              <Link
                href="#"
              ...
              <Link
                href="#"
                className="inline-block bg-[transparent border border-black text-black text-[1.5rem] px-[3rem] py-[1.3rem]  rounded-[5rem] mt-[3rem] xl:text-[2.2rem] xl:py-[1.8rem] xl:px-[6rem] hover:bg-black hover:text-white transition-all duration-500"
              >
                Sell Cars
              </Link>
            </div>
